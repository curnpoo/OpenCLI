...
def main():
    ...
    if "--version" in sys.argv:
        ...
        return
    if "--settings" in sys.argv: interactive_settings_menu()
    ...
    while True:
        try:
            ...
            if user_input.strip() == "/": interactive_settings_menu(); continue
            if user_input.strip() == "/clear":
                messages = [{"role": "system", "content": SYSTEM_PROMPT}]
                session_id = None; console.clear(); banner(mode, p_model); continue
